...
export default function App() {
  ...
  return (
    <View style={styles.container} >
      ...
      <TextInput id='pass' style={{ flex: 0.7, fontSize:17, backgroundColor:'#150655', padding:12, color:'white'}} 
      ...
      <View style={{ flex: 0.3 }}></View>
      <TouchableOpacity style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor:'#18298aeb', borderRadius:5}}>
