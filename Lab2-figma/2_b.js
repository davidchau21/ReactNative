  ...
  return (
    <View style={styles.container} >
      ...
      <View style={{ flex: 1.5, flexDirection:'row'}}>
        ...
        <Text style={{ flex: 4, fontWeight:'bold', fontSize:16}}>USB Bluetooth Music Receiver HJX-001- Biến loa thành loa bluetooth</Text>
      </View>

      <View style={{ flex: 1.5 }}></View>
      <Text style={{ flex: 0.8, fontWeight: 'bold', fontSize: 18, textAlign:'center'}}>Cực kỳ hài lòng</Text>
      ...
      <View style={{ flex: 0.3 }}></View>
      <TextInput style={{ flex: 4, borderWidth:1, borderRadius:5, padding: 10, fontSize:18}} placeholder='Hãy chia sẻ những đều bạn thích về sản phẩm' multiline>
