...
const URL_API = "https://65658cdbeb8bb4b70ef1c95e.mockapi.io/api/v1/appDe2";
      ...
      <View style={styles.style2}>
        ...
        <View style={{ width: '100%', alignItems: 'center', gap: 5, marginTop: 50 }}>
          <TouchableOpacity onPress={handleLogin}
            style={{ borderWidth: 1, fontSize: 18, width: '80%', height: 50, borderRadius: 15, backgroundColor: '#555', alignItems: 'center', justifyContent: 'center' }}>
